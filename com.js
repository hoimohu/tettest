...
function minobag(hold = false) {
    if (game && runstopbool) {
        ...
        //com
        if (hold === false || com.firsthold === true) {
            com.count++;
            if (com.count === 8) {
                com.count = 1;
            }
            if (com.count === 1) {
                ...
                let ljo = '';
                for (let n = 0; n < 7; n++) {
                    let target = nextMino[n];
                    if (target.match(/[ljo]/)) {
                        ljo += target;
                    } else if (target.match(/[szh]/)) {
                        szh += target;
                    }
                }
                if (ljo.match(/^o/)) {
                ...
                if (szh.match(/^t/)) {
                    com.typeSZT = 3;
                } else if (szh.match(/^z.*s$/)) {
                    com.typeSZT = 2;
                } else if (szh.match(/^s.*z$/)) {
                    com.typeSZT = 1;
                }
            }
        }
        if (hold === true) com.firsthold = false;
