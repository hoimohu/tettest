class field {
    ...
    data = [];
    constructor(width, height, element, gameover, pixioption) {
        this.width = width;
        this.height = height;
        ...
        this.rerender = (pixioption != null) ? pixioption.rerender : null;
        this.minostage = (pixioption != null) ? pixioption.stage : null;
    }
    render() {
...
class mino {
    ...
    render() {
        if (this.landing === false) {
            ...
            this.field.minostage[0] = JSON.parse(JSON.stringify(this.field.data));
            for (let i = 0; i < this.data.length; i++) {
                const e = this.data[i];
                if (this.type === 'i') {
                    this.field.minostage[0][this.field.minostage[0].length - 22 + (e[1] * 15 + (shadowY + 22 - this.field.height) * 30 - 15) / 30][(e[0] * 15 + this.x * 30 - 15) / 30] = 'si';
                } else if (this.type === 'o') {
                    this.field.minostage[0][this.field.minostage[0].length - 22 + (e[1] * 15 + (shadowY + 22 - this.field.height) * 30 - 15) / 30][(e[0] * 15 + this.x * 30 - 15) / 30] = 'so';
                } else if (this.type === 't') {
                    this.field.minostage[0][this.field.minostage[0].length - 22 + ((e[1] + shadowY + 22 - this.field.height) * 30) / 30][((e[0] + this.x) * 30) / 30] = 'st';
                } else if (this.type === 's') {
                    this.field.minostage[0][this.field.minostage[0].length - 22 + ((e[1] + shadowY + 22 - this.field.height) * 30) / 30][((e[0] + this.x) * 30) / 30] = 'ss';
                } else if (this.type === 'z') {
                    this.field.minostage[0][this.field.minostage[0].length - 22 + ((e[1] + shadowY + 22 - this.field.height) * 30) / 30][((e[0] + this.x) * 30) / 30] = 'sz';
                } else if (this.type === 'j') {
                    this.field.minostage[0][this.field.minostage[0].length - 22 + ((e[1] + shadowY + 22 - this.field.height) * 30) / 30][((e[0] + this.x) * 30) / 30] = 'sj';
                } else if (this.type === 'l') {
                    this.field.minostage[0][this.field.minostage[0].length - 22 + ((e[1] + shadowY + 22 - this.field.height) * 30) / 30][((e[0] + this.x) * 30) / 30] = 'sl';
                }
            }
            for (let i = 0; i < this.data.length; i++) {
                const e = this.data[i];
                ...
                if (this.type === 'i') {
                    this.field.minostage[0][this.field.minostage[0].length - 22 + (e[1] * 15 + (this.y + 22 - this.field.height) * 30 - 15) / 30][(e[0] * 15 + this.x * 30 - 15) / 30] = 'i';
                } else if (this.type === 'o') {
                    this.field.minostage[0][this.field.minostage[0].length - 22 + (e[1] * 15 + (this.y + 22 - this.field.height) * 30 - 15) / 30][(e[0] * 15 + this.x * 30 - 15) / 30] = 'o';
                } else if (this.type === 't') {
                    this.field.minostage[0][this.field.minostage[0].length - 22 + ((e[1] + this.y + 22 - this.field.height) * 30) / 30][((e[0] + this.x) * 30) / 30] = 't';
                } else if (this.type === 's') {
                    this.field.minostage[0][this.field.minostage[0].length - 22 + ((e[1] + this.y + 22 - this.field.height) * 30) / 30][((e[0] + this.x) * 30) / 30] = 's';
                } else if (this.type === 'z') {
                    this.field.minostage[0][this.field.minostage[0].length - 22 + ((e[1] + this.y + 22 - this.field.height) * 30) / 30][((e[0] + this.x) * 30) / 30] = 'z';
                } else if (this.type === 'j') {
                    this.field.minostage[0][this.field.minostage[0].length - 22 + ((e[1] + this.y + 22 - this.field.height) * 30) / 30][((e[0] + this.x) * 30) / 30] = 'j';
                } else if (this.type === 'l') {
                    this.field.minostage[0][this.field.minostage[0].length - 22 + ((e[1] + this.y + 22 - this.field.height) * 30) / 30][((e[0] + this.x) * 30) / 30] = 'l';
                }
